...
<body>
<div>На этой странице вы можете изменить финансовую цель. Удалить старые транзакции по цели вы сможете через меню управления транзакциями.</div>
<div>
    <form>
    <label> Новая финансовая цель:
        <input type="number" id="formSum" name="sum" min="0" step="0.01">
    </label>
    </form>
</div>
<div id = "stateMessage"></div>
<button type="submit" id="sendData">Обновить финансовую цель</button>
