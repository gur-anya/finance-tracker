package org.ylabHomework.controllers.servlets.transactionServlets.transactionStats.GoalServlets;
...
public class GoalManagementServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        double goal = transactionStatsService.getGoal();
        responseData.put("goal", goal);
