...
public class BudgetService {
    ...
    private final BigDecimal BUDGET_WARNING_PERCENTAGE = BigDecimal.valueOf(90.0);
    ...
    public void handleTransactionAction(TransactionActionEvent event) {
        ...
        BigDecimal percentageLeftToReachLimit = transactionRepository.getPercentageOfBudgetSpent(event.getUserId()).orElse(BigDecimal.ZERO);
        ...
        } else if (percentageLeftToReachLimit.compareTo(BUDGET_WARNING_PERCENTAGE) > 0 && percentageLeftToReachLimit.compareTo(BigDecimal.valueOf(100.0)) < 0) {
        ...
        } else if (percentageLeftToReachLimit.compareTo(BigDecimal.valueOf(100.0)) >= 0) {
