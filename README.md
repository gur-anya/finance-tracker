...
❗ ВАЖНО: для проверки работспособности сервиса отправки уведомлений необходимо заполнить поля NOTIFIER_ в .enx.example значениями собственного SMTP-сервера.
